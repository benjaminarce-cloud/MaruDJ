...
export const copy = {
  en: {
    ...
    epk: {
      issue: "The Ibiza Issue",
      pressKit: "Electronic Press Kit · 2026",
      print: "Print / Save as PDF",
      coverlineL: ["Urban", "Latin House", "House", "Open Format"],
      coverlineR: "From Tucumán to Ibiza — a night with Maru Bravo",
      quote: ["An", "experience", "beyond", "music"],
      bioLabel: "01 — Biography",
      factsLabel: "02 — At a glance",
      facts: [
        ["Artist", "Maru Bravo (Mariana Bravo)"],
        ["Base", "Ibiza — worldwide"],
        ["Origin", "San Miguel de Tucumán, Argentina"],
        ["Sound", "Urban · Latin House · House"],
        ["Format", "Open format DJ sets"],
        ["Experience", "6+ years · ~60 shows a year"],
        ["Rider", "Technical rider available upon request"],
      ],
      platesLabel: "03 — Plates",
      numbersLabel: "04 — The numbers",
      venuesLabel: "Selected venues",
      citiesLabel: "Cities played",
      backLabel: "Bookings & press",
      backLine: "For bookings, press and collaborations",
    },
    hero: {
  ...
  es: {
    ...
    epk: {
      ...
      coverlineL: ["Urban", "Latin House", "House", "Open Format"],
      coverlineR: "De Tucumán a Ibiza — una noche con Maru Bravo",
      quote: ["Una", "experiencia", "más allá de", "la música"],
      bioLabel: "01 — Biografía",
      factsLabel: "02 — En resumen",
      facts: [
        ["Artista", "Maru Bravo (Mariana Bravo)"],
        ["Base", "Ibiza — worldwide"],
        ["Origen", "San Miguel de Tucumán, Argentina"],
        ["Sonido", "Urban · Latin House · House"],
        ["Formato", "DJ sets open format"],
        ["Trayectoria", "6+ años · ~60 shows al año"],
        ["Rider", "Rider técnico disponible bajo petición"],
      ],
      platesLabel: "03 — Láminas",
      numbersLabel: "04 — Los números",
      venuesLabel: "Venues seleccionados",
      citiesLabel: "Ciudades",
      backLabel: "Bookings & prensa",
      backLine: "Para bookings, prensa y colaboraciones",
    },
    hero: {
